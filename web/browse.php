			...
			<div class="product-details">
		 		<?php
		 			...
		 			foreach ($artwork as $art) {
		 				...
		 				echo "<div class='product'><li class='featured'>" . "<img src='$src' alt='$alt'><br>" . $price . "</li></div><br>" . "<div class='add-to-cart'><form method='post'><input type='button' value='RUN' /></form>";
