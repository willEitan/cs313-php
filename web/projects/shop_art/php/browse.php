	...
	<div class="main-content">
		...
		<section id="gallary">
			<?php
				...
				{
					echo "<div class='image-wrapper'><a href='#_'><img src='$row['image']' alt='$row['image_title']'width='400px' height='300px' style='display:block;'><br><p>$row['image_title']</p></a></div><div class='modal'></div>";			
				}
			?>
		</section>
	</div>
