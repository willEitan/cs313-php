...
<body>
	...
	<div class="main-content">
		...
		<div id="featured-gallary"><img src="..\artwork\In_a_Big_World" alt="test"></div>
		<section id="gallary">
			<?php
				...
				{
					echo $row['image'];
					echo "<div class='image-wrapper'><a href='#_'><img src='{$row['image']}' alt='{$row['image_title']}'width='400px' height='300px' style='display:block;'></a>";
